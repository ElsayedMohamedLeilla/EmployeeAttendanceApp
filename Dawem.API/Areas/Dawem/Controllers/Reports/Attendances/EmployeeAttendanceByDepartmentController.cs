...
namespace Dawem.API.Areas.Dawem.Controllers.Reports.Attendance
{
    ...
    public class EmployeeAttendanceByDepartmentController : DawemControllerBase
    {
        private readonly IReportGeneratorBL _reportGeneratorBL;
        public EmployeeAttendanceByDepartmentController(IReportGeneratorBL reportGeneratorBL)
        {
            _reportGeneratorBL = reportGeneratorBL;
        }
        [HttpPost]
        public IActionResult GetEmployeeAttendanceByDepartmentReport([FromQuery] EmployeeAttendanceByDepartmentReportCritria param)
        {
