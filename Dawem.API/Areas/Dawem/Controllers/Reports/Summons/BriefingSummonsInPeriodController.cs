...
namespace Dawem.API.Areas.Dawem.Controllers.Reports
{
    ...
    public class BriefingSummonsInPeriodController : DawemControllerBase
    {
        private readonly IReportGeneratorBL _reportGeneratorBL;
        public BriefingSummonsInPeriodController(IReportGeneratorBL reportGeneratorBL)
        {
            _reportGeneratorBL = reportGeneratorBL;
        }
        [HttpPost]
        public IActionResult GetBriefingSummonsInPeriodReport([FromQuery] BriefingSummonsInPeriodReportCritria param)
        {
