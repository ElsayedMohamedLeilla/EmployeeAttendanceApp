...
namespace Dawem.API.Areas.Dawem.Controllers.Requests.Admin
{
    ...
    public class RequestTaskController : DawemControllerBase
    {
        private readonly IRequestTaskBL requestTaskBL;


        public RequestTaskController(IRequestTaskBL _requestTaskBL)
        {
        ...
        [HttpGet]
        public async Task<ActionResult> GetTasksInformations()
        {
            var response = await requestTaskBL.GetTasksInformations();
