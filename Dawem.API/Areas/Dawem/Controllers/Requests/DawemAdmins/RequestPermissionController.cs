...
namespace Dawem.API.Areas.Dawem.Controllers.Requests.DawemAdmins
{
    ...
    public class RequestPermissionController : DawemControllerBase
    {
        private readonly IRequestPermissionBL requestPermissionBL;


        public RequestPermissionController(IRequestPermissionBL _requestPermissionBL)
        {
        ...
        {
            var response = await requestPermissionBL.GetPermissionsInformations();
