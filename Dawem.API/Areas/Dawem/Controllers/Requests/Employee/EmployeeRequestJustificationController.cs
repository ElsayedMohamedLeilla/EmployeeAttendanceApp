...
namespace Dawem.API.Areas.Dawem.Controllers.Requests.Employee
{
    ...
    public class EmployeeRequestJustificationController : DawemControllerBase
    {
        private readonly IRequestJustificationBL requestJustificationBL;


        public EmployeeRequestJustificationController(IRequestJustificationBL _requestJustificationBL)
        {
