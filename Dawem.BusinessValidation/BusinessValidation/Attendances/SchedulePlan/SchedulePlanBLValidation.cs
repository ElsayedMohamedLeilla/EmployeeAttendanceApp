...
namespace Dawem.Validation.BusinessValidation.Attendances.SchedulePlan
{
    ...
    public class SchedulePlanPlanBLValidation : ISchedulePlanBLValidation
    {
        ...
        public async Task<bool> CreateValidation(CreateSchedulePlanModel model)
        {
            ...
            {
                throw new BusinessValidationException(LeillaKeys.SorrySchedulePlanIsDuplicatedWithSameDateAndSchedule);
            }
