...
namespace Dawem.Validation.FluentValidation.Dawem.Schedules.SchedulePlans
{
    public class UpdateSchedulePlanModelValidator : AbstractValidator<UpdateSchedulePlanModel>
    {
        public UpdateSchedulePlanModelValidator()
        {
            RuleFor(model => model.Id)
                .Must(s => s > 0)
                .WithMessage(LeillaKeys.SorryYouMustEnterSchedulePlanId);
