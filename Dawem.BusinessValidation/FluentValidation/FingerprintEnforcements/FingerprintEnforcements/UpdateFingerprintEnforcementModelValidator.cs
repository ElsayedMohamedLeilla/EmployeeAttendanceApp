...
{
    public class UpdateFingerprintEnforcementModelValidator : AbstractValidator<UpdateFingerprintEnforcementModel>
    {
        public UpdateFingerprintEnforcementModelValidator()
        {
