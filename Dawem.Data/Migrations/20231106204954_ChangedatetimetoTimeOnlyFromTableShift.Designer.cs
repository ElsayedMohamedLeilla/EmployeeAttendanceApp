...
namespace Dawem.Data.Migrations
{
    ...
    [Migration("20231106204954_ChangedatetimetoTimeOnlyFromTableShift")]
    partial class ChangedatetimetoTimeOnlyFromTableShift
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dawem.Domain.Entities.Attendance.WeekAttendance", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("WeekAttendances", "Dawem");
                });

            modelBuilder.Entity("Dawem.Domain.Entities.Attendance.WeekAttendanceShift", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("WeekAttendanceId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("WeekAttendanceId");

                    b.ToTable("WeekAttendanceShifts", "Dawem");
                });
            ...
            modelBuilder.Entity("Dawem.Domain.Entities.UserManagement.RoleClaim", b =>
                {
                    ...
                    b.ToTable("AspNetRoleClaims", "Dawem");
                });
            ...
            modelBuilder.Entity("Dawem.Domain.Entities.UserManagement.UserClaim", b =>
                {
                    ...
                    b.ToTable("AspNetUserClaims", "Dawem");
                });
            ...
            modelBuilder.Entity("Dawem.Domain.Entities.UserManagement.UserLogIn", b =>
                {
                    ...
                    b.ToTable("AspNetUserLogins", "Dawem");
                });
            ...
            modelBuilder.Entity("Dawem.Domain.Entities.UserManagement.UserRole", b =>
                {
                    ...
                    b.ToTable("AspNetUserRoles", "Dawem");
                });
            ...
            modelBuilder.Entity("Dawem.Domain.Entities.UserManagement.UserToken", b =>
                {
                    ...
                    b.ToTable("AspNetUserTokens", "Dawem");
                });
            ...
            modelBuilder.Entity("Dawem.Domain.Entities.Attendance.WeekAttendanceShift", b =>
                {
                    b.HasOne("Dawem.Domain.Entities.Attendance.WeekAttendance", "WeekAttendance")
                        .WithMany("WeekAttendanceShifts")
                        .HasForeignKey("WeekAttendanceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("WeekAttendance");
                });
            ...
            modelBuilder.Entity("Dawem.Domain.Entities.Attendance.WeekAttendance", b =>
                {
                    b.Navigation("WeekAttendanceShifts");
                });
