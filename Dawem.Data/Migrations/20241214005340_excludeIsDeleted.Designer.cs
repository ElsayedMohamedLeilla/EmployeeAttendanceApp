...
namespace Dawem.Data.Migrations
{
    ...
    [Migration("20241214005340_excludeIsDeleted")]
    partial class excludeIsDeleted
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dawem.Domain.Entities.Attendances.EmployeeAttendance", b =>
                {
                    ...
                    b.HasIndex(new[] { "CompanyId", "Code" }, "IX_Unique_CompanyId_Code")
                        .IsUnique()
                    ...
                    b.ToTable("EmployeeAttendances", "Dawem", t =>
                        {
                            ...
                            t.HasTrigger("dbo.DefaultWorkingHours(Id)");
            ...
            modelBuilder.Entity("Dawem.Domain.Entities.Core.DefaultLookus.DefaultLookup", b =>
                {
                    ...
                    b.HasIndex(new[] { "Name" }, "IX_Non_Unique_Name");
            ...
            modelBuilder.Entity("Dawem.Domain.Entities.Core.FingerprintDeviceLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("DeviceLogType")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.ToTable("FingerprintDeviceLogs", "Dawem");
                });
            ...
            modelBuilder.Entity("Dawem.Domain.Entities.Core.OvertimeType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Dawem.Domain.Entities.Employees.Department", b =>
                {
                    ...
                    b.Property<bool>("AllowFingerprintOutsideAllowedZones")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Dawem.Domain.Entities.Requests.RequestOvertime", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("OvertimeHoursCount")
                        .HasColumnType("int");
                    ...
                    b.ToTable("RequestOvertimes", "Dawem");
                });
            ...
            modelBuilder.Entity("Dawem.Domain.Entities.Requests.RequestOvertime", b =>
                {
                    b.HasOne("Dawem.Domain.Entities.Core.OvertimeType", "OvertimeType")
                        .WithMany()
                    ...
                    b.HasOne("Dawem.Domain.Entities.Requests.Request", "Request")
                        .WithOne("RequestOvertime")
                        .HasForeignKey("Dawem.Domain.Entities.Requests.RequestOvertime", "RequestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
