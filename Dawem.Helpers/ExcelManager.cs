    ...
    public static class ExcelManager
    {
        public static MemoryStream ExportEmptyDraft(EmptyExcelDraftModelDTO headerDraftDTO)
        {
            ...
            else if (headerDraftDTO.ExcelExportScreen == ExcelExportScreen.EmployeeAttendance)
            {
                ...
                readmeSheet.Cell(9, 1).Value = "7. RecognitionWay Must Be Of This (FingerPrint , FaceRecognition , VoiceRecognition ,PaternRecognition , PinRecognition or PasswordRecognition ";
                readmeSheet.Cell(10, 1).Value = "9. LocalDate Will Accept DateTime if Date Only Will Entered The Default Time Will Be 00:00 AM";
                readmeSheet.Cell(11, 1).Value = "10. Save the file.";
                // Apply formatting to the "Read Me" sheet
                readmeSheet.Cell(1, 1).Style.Font.Bold = true;
                readmeSheet.Cell(2, 1).Style.Font.Bold = true;
                readmeSheet.Cell(3, 1).Style.Font.Bold = true;
