...
namespace Dawem.Models.AutoMapper
{
    public class AutoMapperConfig : Profile
    {
        public AutoMapperConfig()
        {
            ...
            CreateMap<CreatedUser, MyUser>().ForMember(dest => dest.UserBranches, opt => opt.Ignore()).ForMember(dest => dest.UserGroups, opt => opt.Ignore()).ForMember(dest => dest.UserRoles, opt => opt.Ignore());
