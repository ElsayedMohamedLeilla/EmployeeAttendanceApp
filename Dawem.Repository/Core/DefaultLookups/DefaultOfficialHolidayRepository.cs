...
{
    public class DefaultOfficialHolidayRepository : GenericRepository<DefaultLookup>, IDefaultOfficialHolidayRepository
    {

        private readonly RequestInfo requestInfo;
        public DefaultOfficialHolidayRepository(IUnitOfWork<ApplicationDBContext> unitOfWork, GeneralSetting _generalSetting, RequestInfo _requestInfo) : base(unitOfWork, _generalSetting)
        {
